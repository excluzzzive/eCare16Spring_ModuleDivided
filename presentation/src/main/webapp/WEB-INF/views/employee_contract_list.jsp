...
<c:set var="contractListActive" value="active"/>
...
<c:if test="${editedContract != null}">
    <div class="container">
        <div class="jumbotron">
                ...
                <%--Cancel button--%>
            <form action="/showEmployeeContractListPage" method="post">
                <p class="text-left">
            ...
            <form class="form-horizontal" action="/employeeUpdateContract" method="post">
                    ...
                    <div class="col-sm-4">
                        <select class="form-control" id="tariffSelect" name="tariffId">
                            ...
                            <c:forEach var="phoneNumber" items="${tariffList}">
                                <c:if test="${editedContract.tariff.id != phoneNumber.id}">
                    ...
                    <div class="form-group" id="${tariff.id}" style="${tariffDisplay}">
                        ...
                        <c:forEach var="possibleOption" items="${tariff.possibleOptions}">
                            ...
                            <div class="col-sm-offset-4 col-sm-8">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="${tariff.id}_chosenOptions" id="${tariff.id}"
            ...
            <form action="/employeeDeleteContract" method="post">
                <p class="text-right">
                    <input type="hidden" name="id" value="${editedContract.id}"/>
    ...
    <div class="jumbotron">
        ...
        <table class="table table-condensed table-hover">
            ...
            <c:forEach var="contract" items="${contractList}">
                ...
                <form action="/showEmployeeEditContractByIdPage" method="post">
                        ...
                        <td>
                            <c:if test="${contract.blocked == true}">
                                <button name="btnBlock" value="true" class="btn btn-success btn-xs"
                                        style="width: 55px;" ${disabled}><spring:message code="label.unblock"/>
                                </button>
                            </c:if>
                            <c:if test="${contract.blocked == false}">
                                <button name="btnBlock" value="true" class="btn btn-danger btn-xs"
                                        style="width: 55px;" ${disabled}><spring:message code="label.block"/>
                                </button>
                            </c:if>
                        </td>
                        <td>
