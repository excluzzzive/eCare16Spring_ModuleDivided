...
<div class="container">
    <div class="jumbotron">
        ...
        <%--Create Option Form--%>
        <form class="form-horizontal" action="/employeeCreateOption" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4 text-danger" style="padding-top: 7px">
                    <form:errors path="newOption.name" />
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="number" min="0" max="999" title="<spring:message code="input.optionPriceTitle"/>"
                           class="form-control" id="updateOptionPrice" name="connectionPrice"
                           placeholder="<spring:message code="label.optionConnectionPrice"/>"
                           value="${newOption.connectionPrice}" required>
                </div>
                <div class="col-sm-4 text-danger" style="padding-top: 7px">
                    <form:errors path="newOption.connectionPrice" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4 text-danger" style="padding-top: 7px">
                    <form:errors path="newOption.monthlyPayment" />
                </div>
            </div>
